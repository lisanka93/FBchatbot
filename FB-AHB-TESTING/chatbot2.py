...
def handle_response(statement, checkpointlist, values):
    ...
    if checkpointlist[-1] == 7:
        ...
        value_2 = values[-2]
        if value_1 == value_2:
            response = "What advise would you give a friend who has the same value (" + value_1 + ") how to be more physically active in this situation without compromising her values?"

        else:
            response = "What advise would you give a friend who has the same values (" + value_1 + " and " + value_2 + ") how to be more physically active in this situation without compromising her values?"
    ...
    if checkpointlist[-1] == 12:
        ...
        response = "could you sort the following values by importance to you: " + value_str + " and health. Start with the most important. Type them all in one line"
